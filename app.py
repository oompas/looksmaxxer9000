...
def main():
    ...
    st.set_page_config(page_title="Looksmaxxer9000")
    st.title("Looksmaxxer9000")
    ...
    while cap.isOpened() and not stop_button_pressed:
        ...
        frame_placeholder.image(cv2.cvtColor(annotated_image, cv2.COLOR_RGB2BGR),channels="RGB")
        
        # frame_placeholder.image(padded_raw_feed,channels="RGB")
