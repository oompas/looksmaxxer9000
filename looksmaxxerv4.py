...
while True:
    ...
    if results.multi_face_landmarks:
        ...
        if face_center_y < vertical_center_start:
            cv2.putText(annotated_image, "Face too high", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
        elif face_center_y > vertical_center_end:
            cv2.putText(annotated_image, "Face too low", (10, frame_height - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
